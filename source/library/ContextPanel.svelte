    ...
    {:else if $sidebarState === "creating-multiplayer-session"}
      ...
      <div class="multiplayer-link-wrapper">
        ...
        <div class="multiplayer-link-buttons">
          <button
            class="multiplayer-link-button button--secondary"
            on:click={copyMultiplayerUrl}>Copy</button
          >
          {#if "share" in navigator}
            <button
              class="multiplayer-link-button"
              on:click={shareMultiplayerUrl}>Share</button
            >
          {/if}
        </div>
      </div>
      ...
      >
        ...
        {:else}
          ...
          <button
            ...
            class:hasUnseenSetting={!$settingsLastOpenedAt ||
